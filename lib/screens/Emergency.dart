              ...
              onPressed: () {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                    title: const Text("Instructions for Burning cases"),
                    content: SingleChildScrollView(
                      child: Column(
                        children: [
                          const Text("To beat burns, follow these steps:"
            ...
            borderRadius: BorderRadius.circular(16),
              ...
              onPressed: () {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                    title: const Text("Instructions for Fever Case"),
                    content: SingleChildScrollView(
                      child: Column(
                        children: [
                          const Text("1.Rest"),
                          const Text("2.Drink plenty of fluids to stay hydrated."),
                          const Text("3.Dress in lightweight clothing."),
                          const Text(
                          ...
                          const Text("6.If you're uncomfortable, take acetaminophen"),
                          Image.network(
            ...
            borderRadius: BorderRadius.circular(16),
              ...
              onPressed: () {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                    title: const Text("Instructions for hypertensive cases"),
                    content: SingleChildScrollView(
                      child: Column(
                        children: [
                          const Text(
            ...
            borderRadius: BorderRadius.circular(16),
              ...
              onPressed: () {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                    title: const Text("Instructions for hyperglycemic cases"),
                    content: SingleChildScrollView(
                      child: Column(
                        children: [
                          const Text(
                          ...
                          const Text("4.Check your blood sugar. ... "),
                          const Text("5.Adjust your insulin doses"),
                          Image.network(
